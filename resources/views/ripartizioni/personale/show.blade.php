{{-- resources/views/ripartizioni/personale/show.blade.php --}}
@extends('layouts.app')

@section('content')
<div class="container">
  <h1 class="container-title mb-4">
    Dettaglio Ripartizione – Dipendente #{{ $idDipendente }} – Anno {{ $anno }}
  </h1>
  ...
  <div class="mb-4">
    ...
    <a href="{{ route('ripartizioni.personale.edit', $idDipendente) }}" class="btn btn-warning">
    ...
    <table class="table table-bordered text-center align-middle">
      ...
      <tbody>
        @foreach($convenzioni as $conv)
          @php
            // prendo il valore salvato, o 0 se non esiste
