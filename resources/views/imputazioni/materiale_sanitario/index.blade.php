      ...
      drawCallback: function(settings) {
        ...
        if (storedTotaleRow) {
          ...
          api.columns().every(function(index) {
            ...
            $lastRow.append(`<td class="${alignmentClass} servizi_totale_`+index+`">${cellValue}</td>`);
          });

          $(api.table().body()).append($lastRow);
          
          //titoletto 
          var servizi_totale_1 = $('.servizi_totale_1').text();
          $('#totaleServizi').text(servizi_totale_1);
        }
      },
