...
<script>
  (function() {
    ...
    // riconosce la riga "UTENZE TELEFONICHE"
          ...
          (data || []).forEach(row => {
            ...
            if (editingEnabled) {
              if (isTelefoniaRow(row)) {
                // EDIT dedicato telefonia (doppio campo): route dedicata
                ...
                actionsHtml = `
                <a class="btn btn-warning btn-icon" href="${editTelUrl}?${qs}" title="Modifica utenze telefoniche">
                  <i class="fas fa-edit"></i>
                </a>
              `;
              } else {
                // EDIT standard (singola voce): ensure -> edit
                ...
                actionsHtml = `
                <a class="btn btn-warning btn-icon" href="${ensureUrl}?${qs}" title="Modifica">
                  <i class="fas fa-edit"></i>
                </a>
              `;
              }
    ...
    // listener pulsanti "Modifica Preventivi" (bulk per sezione)
